...
int cardEffect_mine(struct gameState *state, int currentPlayer, int choice1, int choice2, int handPos) {
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	{
	case adventurer:
		cardEffect_adventurer(state, currentPlayer);
		return 0;

	case council_room:
		cardEffect_council_room(state, currentPlayer, handPos);
		return 0;

	case feast:
		cardEffect_feast(state, currentPlayer, choice1);
		return 0;
	...
	case mine:
		if (cardEffect_mine(state, currentPlayer, choice1, choice2, handPos) == -1) {
			return -1;
		}
		return 0;
